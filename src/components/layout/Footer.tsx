        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-xs text-gray-500">
              CNPJ 00.000.000/0001-00, Registrada no
              <br />
              Brasil.
            </p>
          </div>

          {/* Col 2 — Newsletter + Redes */}
          <div className="flex flex-col gap-5">
            <div>
              <p className="mb-3 font-semibold text-gray-900">Redes Sociais</p>
            </div>
          ...
          {/* Col 3 — Links legais */}
          <div>
            <h4 className="mb-4 font-semibold text-gray-900">Páginas Legais</h4>
          ...
          <div>
            <h4 className="mb-4 font-semibold text-gray-900">Links Importantes</h4>
            <ul className="space-y-3 text-sm text-gray-500">
              <li>
                <Link href="#" className="hover:text-gray-900">
                  Ajuda
